...
"""
/***************************************************************************
 FeatureNavigationDockDockWidget
                                 A QGIS plugin
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'feature_navigation_dock_dockwidget_base.ui'))


class FeatureNavigationDockDockWidget(QtWidgets.QDockWidget, FORM_CLASS):

    closingPlugin = pyqtSignal()

    def __init__(self, parent=None):
        """Constructor."""
        super(FeatureNavigationDockDockWidget, self).__init__(parent)
