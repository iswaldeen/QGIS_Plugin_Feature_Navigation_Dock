...
from .feature_navigation_dock_dockwidget import FeatureNavigationDockDockWidget
from .feature_navigation_dock_dialog import FeatureNavigationDockSettingsDialog
import os.path
...
class FeatureNavigationDock:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FeatureNavigationDock_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Feature Navigation Dock')
        # TODO: We are going to let the user set this up in a future iteration

        #print "** INITIALIZING FeatureNavigationDock"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('FeatureNavigationDock', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/feature_navigation_dock/icons/feature_navigation_dock_icon.png'
        self.add_action(
            icon_path,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget is None:
                ...
                self.dockwidget = FeatureNavigationDockDockWidget()
                ...
                self.playback_interval_ms = QSettings().value("FeatureNavigationDock/playbackInterval", 1000, type=int)
            ...
            settings = QSettings()
            spacebar_enabled = settings.value("FeatureNavigationDock/enableSpacebarPlayPause", False, type=bool)
            ...
            self.selected_features_only = settings.value(
                "FeatureNavigationDock/selectedFeaturesOnly",
                False,
                type=bool
            )
            
            self.loop_navigation_enabled = settings.value(
                "FeatureNavigationDock/loopNavigation",
                False,
                type=bool
            )
            
            self.nav_slider_enabled = settings.value(
                "FeatureNavigationDock/showNavigationSlider",
                True,
                type=bool
            )
    ...
    def select_feature(self):
        ...
        if geom and not geom.isNull() and not geom.isEmpty():
            buffer_size = QSettings().value(
                "FeatureNavigationDock/zoomBuffer",
                1.0,
                type=float
            )
    ...
    def toggle_play_pause_from_spacebar(self):
        ...
        settings = QSettings()
        enabled = settings.value("FeatureNavigationDock/enableSpacebarPlayPause", False, type=bool)
        if not enabled:
            return
    ...
    def show_settings_dialog(self):
        ...
        dialog = FeatureNavigationDockSettingsDialog()

        settings = QSettings()
        current_interval_ms = settings.value("FeatureNavigationDock/playbackInterval", 1000, type=int)
        current_zoom_buffer = settings.value("FeatureNavigationDock/zoomBuffer",1.0,type=float)
        current_spacebar_enabled = settings.value("FeatureNavigationDock/enableSpacebarPlayPause", False, type=bool)
        current_selected_only = settings.value("FeatureNavigationDock/selectedFeaturesOnly", False, type=bool)
        current_loop_enabled = settings.value("FeatureNavigationDock/loopNavigation",False,type=bool)
        current_nav_slider_enabled = settings.value("FeatureNavigationDock/showNavigationSlider",True,type=bool)
        ...
        if dialog.exec() == DIALOG_ACCEPTED:
            ...
            settings.setValue("FeatureNavigationDock/playbackInterval", new_interval_ms)
            settings.setValue("FeatureNavigationDock/zoomBuffer", new_buffer_m)
            settings.setValue("FeatureNavigationDock/enableSpacebarPlayPause", new_spacebar_enabled)
            settings.setValue("FeatureNavigationDock/selectedFeaturesOnly", new_selected_only)
            settings.setValue("FeatureNavigationDock/loopNavigation", new_loop_enabled)
            settings.setValue("FeatureNavigationDock/showNavigationSlider", new_nav_slider_enabled)
